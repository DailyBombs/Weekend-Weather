...
function renderSliders(inputRange) {
  ...
  try {
    for (var _iterator = keys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var maxTitle = _inputRange$props2.maxTitle;
      var minTitle = _inputRange$props2.minTitle;
...
var InputRange = (function (_React$Component) {
   ...
   * @property {Function} maxTitle
   * @property {Function} minTitle
...
InputRange.propTypes = {
  ...
  maxTitle: _react2['default'].PropTypes.string,
  minTitle: _react2['default'].PropTypes.string,
 ...
 * @property {string} maxTitle
 * @property {string} minTitle
